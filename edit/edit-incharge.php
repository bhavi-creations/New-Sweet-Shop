<div id="wrapper">
    ...
    if (isset($_POST['edit_btn'])) {
        ...
        $staffQuery = mysqli_query($db_con, "UPDATE   incharge  SET  PersonName='" . $prsn . "',  Address='" . $add . "',Age='" . $age . "', Account='" . $acnt ."',Phone='" . $phn . "',Salary='" . $slry . "',Branch='" . $brnch . "',Joining='" . $jng . "',Image='" . $image . "',status=1 where id='" . $getId . "'");
